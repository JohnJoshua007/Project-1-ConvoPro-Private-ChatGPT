...
# Change import to Gemini
from llm_factory.get_llm import get_gemini_llm


def get_chat_title(model: str, user_query: str):
    """
    Generate a short, catchy title for the user's query using the specified Gemini model.
    """
    llm = get_gemini_llm(model)   # now returns Gemini LLM
