...
#
# from services.get_models import get_ollama_models_list
...
# Change import from Ollama to Gemini
from services.get_models import get_gemini_models_list
from services.get_title import get_chat_title
from services.chat_utilities import get_answer
from db.conversations import (
    create_new_conversation,
...
st.set_page_config(page_title="ConvoPro – Gemini AI", page_icon="💬", layout="centered")
st.title("🤖 ConvoPro – Gemini AI")

# ---- Models ----
# Use a generic session state key for clarity
if "AVAILABLE_MODELS" not in st.session_state:
    st.session_state.AVAILABLE_MODELS = get_gemini_models_list()
